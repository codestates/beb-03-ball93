...
use cosmwasm_std::{CanonicalAddr, StdResult, Storage, Uint128, Addr};
...
pub struct State {
    ...
    pub cw20_contract_address: CanonicalAddr, //cw20 컨트랙트주소
}
...
//JACKPOT :lottery_id ->JackpotNum:{worker:Canoncial,round : String}
