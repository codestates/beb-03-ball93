...
const StyledButton = styled.button<BaseButtonProps>`
  ...
  &:hover:not(:disabled):not(.token-button--disabled):not(.token-button--disabled):not(:active) {
    opacity: 0.65;
  }

  &:active:not(:disabled):not(.token-button--disabled):not(.token-button--disabled) {
    opacity: 0.85;
