/**
 * @see https://github.com/DecentralizedLotto/token-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  token: {
    symbol: 'TOKEN',
    ...
    decimals: 18,
    projectLink: 'https://DecentralizedLotto.finance/',
  },
  txl: {
    symbol: 'TXL',
    address: {
  ...
  bunny: {
    ...
    decimals: 18,
    projectLink: 'https://tokenbunny.finance/',
  },
  alice: {
    symbol: 'ALICE',
    address: {
