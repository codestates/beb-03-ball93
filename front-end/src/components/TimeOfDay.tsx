const TimeOfDay = ({
  ...
  return (
    <div className='container md:w-7/12 scale-150 mx-auto p-1'>
      <div className='main-content '>
        {/* <h1>Favorite time of the day?</h1> */}
        <div className='option-wrapper bg-black-500'>
          <div
            className={type === 'day' ? 'option active' : 'option'}
            data-option='day'
            onClick={() => setType('day')}
          >
            1st
          ...
          <div
            className={type === 'sunset' ? 'option active' : 'option'}
            data-option='sunset'
            onClick={() => setType('sunset')}
          >
            2nd
          </div>
          <div
            className={type === 'dusk' ? 'option active' : 'option'}
            data-option='dusk'
            onClick={() => setType('dusk')}
          >
            3rd
          </div>

          <div
            className={type === 'night' ? 'option active' : 'option'}
            data-option='night'
              ...
              <div className='sky'>
                <svg width='250px' viewBox='0 0 113.39 99.21'>
                  ...
                  <polygon
                    fill='#B3EFFF'
                    id='sky'
                    points='111.971,97.368 111.971,1.842 1.419,1.842 1.419,9.042 1.419,97.368'
                  ></polygon>
                </svg>
              </div>
              <div className='sun'>
              ...
              <div className='land'>
                <svg width='250px' viewBox='0 0 113.39 24.09'>
                  <path
                    id='land'
                    fill='#4CB5AB'
                    d='M111.971,23.82V3.328C84.865-6.96,12.407,11.765,1.419,14.708v9.112H111.971z'
                  ></path>
                </svg>
              </div>
              <div className='trees'>
      ...
      <style jsx>{`
        .container {
          /* background: radial-gradient(#b2b2b2, #e4e3e3); */
        }
        .main-content {
          max-width: 700px;
          margin: 4em auto 0;
